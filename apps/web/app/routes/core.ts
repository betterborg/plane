    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/(workspace)/layout.tsx", [
          ...
          route(
            ":workspaceSlug/settings/integrations/google-calendar",
            "./(all)/[workspaceSlug]/(settings)/settings/(workspace)/integrations/google-calendar/page.tsx"
          ),
          route(
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            route(
              ":workspaceSlug/settings/projects/:projectId/features/google-calendar",
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/features/google-calendar/page.tsx"
            ),
            // Project States
            route(
